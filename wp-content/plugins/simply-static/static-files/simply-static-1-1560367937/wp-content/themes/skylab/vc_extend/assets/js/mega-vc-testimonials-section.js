	...
	window.VcBackendTtaViewInterface = vc.shortcode_view.extend({
            ...
            addSection: function(prepend) {
                ...
                return newTabTitle = this.defaultSectionTitle, params = {
                    shortcode: "vc_tta_section_testimonials",
                    params: {
                        title: newTabTitle
                    },
                    parent_id: this.model.get("id"),
            ...
            buildSortable: function($element) {
                return "edit" !== vc_user_access().getState("shortcodes") && vc_user_access().shortcodeAll("vc_tta_section_testimonials") ? $element.sortable({
            ...
            updateSorting: function(event, ui) {
                var self;
                return vc_user_access().shortcodeAll("vc_tta_section_testimonials") ? (self = this, this.$sortable.find(this.sortableSelector).each(function() {
...
window.VcBackendTtaAccordionTestimonialsView = VcBackendTtaViewInterface.extend({
            ...
            render: function() {
                return window.VcBackendTtaTabsView.__super__.render.call(this), this.$navigation = this.$content, this.$sortable = this.$content, vc_user_access().shortcodeAll("vc_tta_section_testimonials_testimonials") || this.$content.find(".vc_tta-section-append").hide(), this
            },
