<?php
	...
	class XforWC_Product_Filters_Settings {
		...
		public static function ___get_hide_elements_option() {
			return array(
				...
				'options' => array(
					...
					'none' => apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'prdctfltr' ) ),
				),
				'class' => 'svx-selectize',
			);
		}
		...
		public static function get_settings( $plugins ) {
			...
			$ajax = XforWC_Product_Filters_Get_Theme::get_theme_ajax();

			$plugins['product_filter'] = array(
				'slug' => 'product_filter',
				'name' => function_exists( 'XforWC' ) ? esc_html__( 'Product Filters', 'prdctfltr' ) : esc_html__( 'Product Filter for WooCommerce', 'prdctfltr' ),
				'desc' => function_exists( 'XforWC' ) ? esc_html__( 'Product Filter for WooCommerce', 'prdctfltr' ) . ' v' . Prdctfltr()->version() : esc_html__( 'Settings page for Product Filter for WooCommerce!', 'prdctfltr' ),
				...
				'extras' => array(
					...
					'more_titles' => array(
						...
						'instock' => esc_html__( 'Avalibility', 'prdctfltr' ),
			...
			$plugins['product_filter']['settings'] = array_merge( $plugins['product_filter']['settings'], array(
				...
				's_js_scroll' => array(
					'name' => esc_html__( 'JS Scroll Bars', 'prdctfltr' ),
					'type' => 'checkbox',
					'desc' => esc_html__( 'Enable JavaScript scroll bars for nicer display', 'prdctfltr' ),
					'section' => 'presets',
					'id'   => 's_js_scroll',
					'default' => 'no',
					'condition' => '_filter_preset_options:style',
				...
				's_hierarchy_style' => array(
					'name' => esc_html__( 'Hierarchy Syyle', 'prdctfltr' ),
					'type' => 'select',
				...
				'r_behaviour' => array(
					...
					'options'   => array(
						...
						'show' => esc_html__( 'Show after resolution matches', 'prdctfltr' ),
						'hide' => esc_html__( 'Hide after resolution matches', 'prdctfltr' ),
					),
					'default' => 'none',
				...
				'r_resolution' => array(
					...
					'type' => 'number',
					'desc' => esc_html__( 'Set screen resolution that wil trigger the responsive behaviour', 'prdctfltr' ),
					'section' => 'presets',
					'id'   => 'r_resolution',
					'default' => '768',
					'condition' => '_filter_preset_options:responsive',
			...
			$plugins['product_filter']['settings'] = array_merge( $plugins['product_filter']['settings'], array(
				...
				'automatic' => array(
					...
					'type' => 'checkbox',
					'desc' => esc_html__( 'Check this option to use automatic AJAX installation.', 'prdctfltr' ) . ' <strong>' . ( isset( $ajax['recognized'] ) ? esc_html__( 'AJAX is set for', 'prdctfltr' ) . ' ' . $ajax['name'] . '.' : esc_html__( 'Theme not found in database. Using default compatibility mode.', 'prdctfltr' ) ) . '</strong>',
					'section' => 'ajax',
					'id'   => 'automatic',
					'default' => 'yes',
					'class' => 'svx-refresh-active-tab',
				...
				'wrapper' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter product wrapper jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['wrapper'],
					'section' => 'ajax',
					'id'   => 'wrapper',
					'default' => '',
				...
				'category' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter product category jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['category'],
					'section' => 'ajax',
					'id'   => 'category',
					'default' => '',
					'condition' => 'enable:yes&&automatic:no',
				...
				'product' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter product jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['product'],
					'section' => 'ajax',
					'id'   => 'product',
					'default' => '',
					'condition' => 'enable:yes&&automatic:no',
				...
				'result_count' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter result count jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['result_count'],
					'section' => 'ajax',
					'id'   => 'result_count',
					'default' => '',
					'condition' => 'enable:yes&&automatic:no',
				...
				'order_by' => array(
					'name' => esc_html__( 'Order By', 'prdctfltr' ),
					'type' => 'text',
					'desc' => esc_html__( 'Enter order by jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['order_by'],
					'section' => 'ajax',
					'id'   => 'order_by',
					'default' => '',
					'condition' => 'enable:yes&&automatic:no',
				...
				'pagination' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter pagination jQuery selector.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . $ajax['pagination'],
					'section' => 'ajax',
					'id'   => 'pagination',
					'default' => '',
					'condition' => 'enable:yes&&automatic:no',
				...
				'pagination_function' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Enter pagination function.', 'prdctfltr' ) . ' ' . esc_html( 'Currently set to', 'prdctfltr' ) . ': ' . ( isset( $ajax['pagination_function'] ) ? $ajax['pagination_function'] : 'woocommerce_pagination' ),
					'section' => 'ajax',
					...
					$array['_pf_manager_' . $taxonomy->name] = array(
						...
						'settings' => array(
							...
							'term' => array(
								...
								'options' => 'ajax:taxonomy:' . $taxonomy->name . ':has_none',
								'default' => ''
							),
							'preset' => array(
								'name' => esc_html__( 'Preset', 'prdctfltr' ),
