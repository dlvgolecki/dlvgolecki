...
<div class="kalium-whats-new">
	...
	<div class="feature-section two-col">
        <div class="col">
            ...
            <p>
                Crafted specifically for bookshop sites, publishers, writing authors, reviewers, book distributors, anyone whose work concerning writing and other book-related services.
        ...
        <div class="col">
            <img src="<?php echo kalium()->assetsUrl( 'images/admin/whats-new/woocommerce-36.jpg' ); ?>">
            <h3>WooCommerce 3.6 compatibility</h3>
            <p>
                Added compatibility for latest stable WooCommerce version (3.6.x). Feel safe to update!
            </p>
        </div>
	</div>
