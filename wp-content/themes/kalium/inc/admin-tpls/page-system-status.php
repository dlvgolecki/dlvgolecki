...
?>
<div class="wrap about-wrap kalium-about-wrap product-activation-wrap">
	...
	<div class="laborator-system-status-data">
		...
		<table class="widefat">
			...
			<tbody>
                ...
                <tr>
                    <td>WP Path:</td>
                    <td class="help"><?php Laborator_System_Status::tooltip( 'System path of your WordPress root directory.' ); ?></td>
                    <th>
						<?php echo ABSPATH; ?>
                    </th>
                </tr>
                <tr>
                    <td>WP Content Path:</td>
                    <td class="help"><?php Laborator_System_Status::tooltip( 'System path of your wp-content directory.' ); ?></td>
                    <th>
			...
			<tbody>
					...
					<th>
						...
						if ( function_exists( 'phpversion' ) ) {
							...
							if ( version_compare( $php_version, '5.6.20', '<' ) ) {
								echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . sprintf( '%s - We recommend a minimum PHP version of 5.6. See: %s', esc_html( $php_version ), '<a href="https://documentation.laborator.co/kb/kalium/kalium-server-requirements/" target="_blank">How to update your PHP version</a>' ) . '</mark>';
							} else if ( version_compare( $php_version, '7.3', '<' ) ) {
								echo sprintf( '%s - We recommend using PHP version 7.3 or above for greater performance and security. See: %s', esc_html( $php_version ), '<a href="https://documentation.laborator.co/kb/kalium/kalium-server-requirements/" target="_blank">How to update your PHP version</a>' );
							} else {
				...
				<tr>
					...
					<th>
						<?php
						if ( $wpdb->use_mysqli ) {
							echo mysqli_get_server_info( $wpdb->dbh ); // @codingStandardsIgnoreLine.
						} else {
							echo mysql_get_server_info( $wpdb->dbh ); // @codingStandardsIgnoreLine.
						}
                        ?>
					</th>
				</tr>
		...
		<table class="widefat">
			...
			<tbody>
				<tr>
					...
					<td class="help"><?php Laborator_System_Status::tooltip( 'Does your site uses SSL certificate for secure connection.' ); ?></td>
					<th>
						<?php echo $is_https ? $mark_yes : '<mark class="error">Your site is not using secure connection (HTTPS). <a href="https://docs.woocommerce.com/document/ssl-and-https/" target="_blank">Learn more &raquo;</a></mark>'; ?>
					</th>
				</tr>
				<tr>
					<td>Hide errors from visitors:</td>
					<td class="help"><?php Laborator_System_Status::tooltip( 'Error messages can contain sensitive information about your website. These should be hidden from untrusted visitors.' ); ?></td>
					<th>
						<?php echo $hide_errors ? $mark_yes : '<mark class="error">Error messages should not be shown to visitors.</mark>'; ?>
					</th>
				</tr>
			</tbody>
		</table>
