...
$faq_articles = array(
	...
	array(
		...
		'content' => 'Your Kalium purchase requires product registration to install demo content, premium plugin updates and automatic theme updates. You can easily register your product on the <a href="' . admin_url( 'admin.php?page=kalium-product-registration' )  . '">Product Registration</a> tab.',
...
?>
<div class="wrap about-wrap kalium-about-wrap">
